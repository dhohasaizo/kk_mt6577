...
# LGE_CHANGE_S : 2012-10-15 johny.kim@lge.com
# add CONFIGS to enable bootchart2
if [ "${INIT_BOOTCHART2}" == "true" ]; then
	echo "CONFIG_TASKSTATS=y" >> $defcfg
	echo "CONFIG_TASK_DELAY_ACCT=y" >> $defcfg
	echo "CONFIG_TASK_XACCT=y" >> $defcfg
	echo "CONFIG_TASK_IO_ACCOUNTING=y" >> $defcfg
	echo "CONFIG_CONNECTOR=y" >> $defcfg
	echo "CONFIG_PROC_EVENTS=y" >> $defcfg
fi
# LGE_CHANGE_E : 2012-10-15 johny.kim@lge.com

# LGE_CHANGE_S : 2012-10-24 johny.kim@lge.com
# add CONFIGS to enable bootlog
if [ "${INIT_BOOTLOG}" == "true" ]; then
	echo "CONFIG_LGE_BOOTLOADER_LOG=y" >> $defcfg
fi
# LGE_CHANGE_E : 2012-10-24 johny.kim@lge.com
