...
#ifdef CONFIG_LGE_HYBRID_CPU_BOOST
#define DEFAULT_FREQ_BOOST_TIME  (500000)
#define DEFAULT_BOOST_FREQ       (1001000)
...
#ifdef CONFIG_LGE_HYBRID_CPU_BOOST
show_one_unsigned(boostpulse, boosted);
show_one_unsigned(boosttime, freq_boost_time);
show_one_unsigned(boostfreq, boostfreq);
...
#ifdef CONFIG_LGE_HYBRID_CPU_BOOST
define_one_global_rw_lge(boostpulse);
define_one_global_rw_lge(boosttime);
define_one_global_rw_lge(boostfreq);
#endif
