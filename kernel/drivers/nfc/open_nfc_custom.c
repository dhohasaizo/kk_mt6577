...
#define GPIO_NFC_EINT_PIN 60
#define GPIO_NFC_EINT_PIN_M_EINT 1
#define GPIO_DIR_IN 0
#define GPIO_PULL_ENABLE 1
#define GPIO_PULL_DOWN 0

#define GPIO_NFC_VEN_PIN 111
#define GPIO_NFC_VEN_PIN_M_GPIO 0
#define GPIO_DIR_OUT 1

#define CUST_EINT_NFC_NUM 8
...
s32 nfc_mt_set_clock_output(u32 num, u32 src, u32 div)
{
    u32 pin_reg;
    u32 reg_value = 0;
    if (num >= CLK_MAX )
...
opennfc_probe(struct i2c_client *client, const struct i2c_device_id *idp)
{
    ...
    mt_eint_set_sens(CUST_EINT_NFC_NUM, CUST_EINT_LEVEL_SENSITIVE);
    mt_eint_set_hw_debounce(CUST_EINT_NFC_NUM, CUST_EINT_NFC_DEBOUNCE_CN);
    mt_eint_registration(CUST_EINT_NFC_NUM, CUST_EINT_POLARITY_HIGH, open_nfc_i2c_interrupt, 0);
    //mt_eint_unmask(CUST_EINT_NFC_NUM);
    ...
    // Initializing the CLK for the chipset  AD16(32K_OUT) -> KP_COL7(AJ5) 
    mt_set_gpio_mode(GPIO96, 3); //set to mode3: CLKM5 
    mt_set_gpio_dir(GPIO96, 1); //set to output
    nfc_mt_set_clock_output(5 , 2 , 1); //set CLKM5 to clocksrc:32K, divider:1
