...
#ifdef MTK_FPGA_PLATFORM_SUPPORT
...
struct msdc_host
{
    ...
    u8                          polling;        /* do polling interrupt in resume callback*/
    u8                          reserved;
    ...
    bool                        block_damage_card;
    bool                        card_cd_pin_state;
    bool                        force_check_card_state;
    spinlock_t                  state_check_lock;    
