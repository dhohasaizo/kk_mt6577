...
#else
	xlog_printk(ANDROID_LOG_DEBUG, "Power/Battery", "[FGADC] MT6329 FGADC driver probe!! \n" );
...
{
	xlog_printk(ANDROID_LOG_DEBUG, "Power/Battery", "[FGADC] MT6329 FGADC driver remove!! \n" );
...
{
	xlog_printk(ANDROID_LOG_DEBUG, "Power/Battery", "[FGADC] MT6329 FGADC driver shutdown!! \n" );
}
...
static int __init mt6329_fgadc_init(void)
{
	...
	if (ret) {
		xlog_printk(ANDROID_LOG_DEBUG, "Power/Battery", "****[mt6329_fgadc_driver] Unable to device register(%d)\n", ret);
		return ret;
	}

    ret = platform_driver_register(&mt6329_fgadc_driver);
	if (ret) {
		xlog_printk(ANDROID_LOG_DEBUG, "Power/Battery", "****[mt6329_fgadc_driver] Unable to register driver (%d)\n", ret);
		return ret;
	}

	xlog_printk(ANDROID_LOG_DEBUG, "Power/Battery", "****[mt6329_fgadc_driver] Initialization : DONE \n");
