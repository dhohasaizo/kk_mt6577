    ...
    while (1) {           
        ...
        if(ret==1)
        {
            ...
            if(ret==1)
            {
                ...
                xlog_printk(ANDROID_LOG_ERROR, "LGBM", "[pmic_thread_kthread] charger exist!\r\n");
#else
...
#if defined ( LGE_BSP_LGBM )
                xlog_printk(ANDROID_LOG_ERROR, "LGBM", "[pmic_thread_kthread] charger NOT exist!\r\n");
#else
