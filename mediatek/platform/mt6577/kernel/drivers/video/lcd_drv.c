...
#ifdef CONFIG_LGE_MTK_LCDC_LUT
//                                                      
	LCD_OUTREG32(&regs->GAMCON, AS_UINT32(&LCD_REG->GAMCON));
#endif
...
#ifdef CONFIG_LGE_MTK_LCDC_LUT
//                                                      
	LCD_OUTREG32(&LCD_REG->GAMCON, AS_UINT32(&regs->GAMCON));
#endif
