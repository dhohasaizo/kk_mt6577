...
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl \
                      $(MTK_ROOT_CONFIG_OUT)/mtk-kpd.kcm:system/usr/keychars/mtk-kpd.kcm \
                      ...
                      $(MTK_ROOT_CONFIG_OUT)/mpeg4_venc_parameter.cfg:system/etc/mpeg4_venc_parameter.cfg \
...
_init_minios_rc := $(MTK_ROOT_CONFIG_OUT)/init.miniOS.rc
ifneq ($(wildcard $(_init_minios_rc)),)
PRODUCT_COPY_FILES += $(_init_minios_rc):root/init.miniOS.rc
endif
...
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/mtofn.idc:system/usr/idc/mtofn.idc
endif
...
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/local.prop:data/local.prop
endif
endif
##################################
