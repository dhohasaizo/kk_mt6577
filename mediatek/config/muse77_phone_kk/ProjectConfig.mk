...
CUSTOM_HAL_IMGSENSOR = imx111_mipi_raw imx219_mipi_raw imx119_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = imx111_mipi_raw imx219_mipi_raw imx119_mipi_raw
...
CUSTOM_MODEM = mt6577phone_hspa_gemini_prod
...
CONFIG_MAX8971_CHARGER = yes
#LGE_CHANGE_S : 2014-04-08 tapan.sahu@lge.com
TARGET_S1_77 = yes
#LGE_CHANGE_E : 2014-04-08 tapan.sahu@lge.com
...
#/* LGE_CHANGE_S : 2014-03-20, euna.jo@lge.com ,for gain table */
MTK_AUDIO_GAIN_TABLE_SUPPORT = yes
MTK_AUDIO_HD_REC_SUPPORT = yes
#/* LGE_CHANGE_S : 2014-04-3, euna.jo@lge.com ,for gain table and VR*/
...
MTK_RELEASE_PACKAGE = rel_customer_lge rel_customer_platform_mt6577 rel_customer_bsp
...
#/* 2014-02-24 byunghyun.lee@lge.com LGP_DATA_UMTS_MTK_RIL_SM_CAUSE  [START]  */
MTK_SPECIFIC_SM_CAUSE = yes
#/* 2014-02-24 byunghyun.lee@lge.com LGP_DATA_UMTS_MTK_RIL_SM_CAUSE  [END]  */
...
#/* Temporary fix build error S*/
MTK_TC1_FEATURE = yes
#/* Temporary fix build error E*/
...
CONFIG_LGE_USB_GADGET_DRIVER = yes
CONFIG_LGE_USB_AUTORUN_DRIVER = yes

LGE_AUDIO_DDPLUS_SUPPORT = yes
