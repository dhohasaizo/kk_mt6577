...
#define MCSDL_VDD_SET_HIGH()             			hwPowerOn(MT65XX_POWER_LDO_VGP2, VOL_3000, "TP");
#define MCSDL_VDD_SET_LOW()              			hwPowerDown(MT65XX_POWER_LDO_VGP2, "TP");
#else
...
#define MCSDL_GPIO_SCL_SET_HIGH()					mt_set_gpio_out(GPIO_I2C0_SCA_PIN, 1);
#define MCSDL_GPIO_SCL_SET_LOW()					mt_set_gpio_out(GPIO_I2C0_SCA_PIN, 0);

#define MCSDL_GPIO_SDA_SET_HIGH()					mt_set_gpio_out(GPIO_I2C0_SDA_PIN, 1);
#define MCSDL_GPIO_SDA_SET_LOW()					mt_set_gpio_out(GPIO_I2C0_SDA_PIN, 0);

#define MCSDL_GPIO_SCL_SET_OUTPUT()					mt_set_gpio_dir(GPIO_I2C0_SCA_PIN, GPIO_DIR_OUT);
#define MCSDL_GPIO_SCL_SET_INPUT()					mt_set_gpio_dir(GPIO_I2C0_SCA_PIN, GPIO_DIR_IN);
#define MCSDL_GPIO_SCL_IS_HIGH()					((gpio_get_value(GPIO_I2C0_SCA_PIN)>0)?1:0)

#define MCSDL_GPIO_SDA_SET_OUTPUT()					mt_set_gpio_dir(GPIO_I2C0_SDA_PIN, GPIO_DIR_OUT);
#define MCSDL_GPIO_SDA_SET_INPUT()					mt_set_gpio_dir(GPIO_I2C0_SDA_PIN, GPIO_DIR_IN);

#define MCSDL_GPIO_SDA_IS_HIGH()					((mt_get_gpio_in(GPIO_I2C0_SDA_PIN)>0)?1:0)
