...
/* X/Y Starting point */
#define IMX119MIPI_IMAGE_SENSOR_PV_STARTX       2
#define IMX119MIPI_IMAGE_SENSOR_PV_STARTY       2	// The value must bigger or equal than 1.
#define IMX119MIPI_IMAGE_SENSOR_CAP_STARTX		2
#define IMX119MIPI_IMAGE_SENSOR_CAP_STARTY		2// The value must bigger or equal than 1.
...
#define IMX119MIPI_PV_FRAME_LENGTH_LINES						(1064)	
#define IMX119MIPI_FULL_LINE_LENGTH_PIXELS 						(1392)
#define IMX119MIPI_FULL_FRAME_LENGTH_LINES			            (1064)
