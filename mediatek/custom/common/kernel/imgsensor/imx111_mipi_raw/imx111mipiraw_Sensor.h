...
#define IMX111MIPI_IMAGE_SENSOR_CCT_WIDTH		(3536)
#define IMX111MIPI_IMAGE_SENSOR_CCT_HEIGHT		(2530)

#define IMX111MIPI_PV_LINE_LENGTH_PIXELS 						(3536)
#define IMX111MIPI_PV_FRAME_LENGTH_LINES						(1266)	
#define IMX111MIPI_FULL_LINE_LENGTH_PIXELS 						(3536)
#define IMX111MIPI_FULL_FRAME_LENGTH_LINES			            (2530)
