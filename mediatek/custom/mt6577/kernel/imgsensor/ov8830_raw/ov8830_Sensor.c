...
#define OV8830_ZSD_PRE_CLK 117000000
...
static OV8830_sensor_struct OV8830_sensor =
{
  ...
  .shutter = 0x100,// for preview func set shutter, 
};
...
OV8830_Write_Shutter(kal_uint16 ishutter)
{
...
static void OV8830_set_isp_driving_current(kal_uint8 current)
{
#ifdef OV8830_DRIVER_TRACE
...
inline static kal_bool OV8830_set_sensor_item_info(MSDK_SENSOR_ITEM_INFO_STRUCT *para)
{
  ...
  case OV8830_CMMCLK_CURRENT:
    ...
    case 0:
      ...
      OV8830_set_isp_driving_current(temp_para);
	  spin_lock(&ov8830_drv_lock);
...
OV8830_1632_1224_2Lane_30fps_Mclk26M_setting(void)
{
...
OV8830_3264_2448_2Lane_15fps_Mclk26M_setting(void)
{
...
OV8830_3264_2448_2Lane_13fps_Mclk26M_setting(void)
{
...
UINT32 OV8830SetVideoMode(UINT16 u2FrameRate)
{
    ...
    if((30 == u2FrameRate)||(15 == u2FrameRate))
    	{
			dummy_line = OV8830_sensor.pv_pclk / u2FrameRate / OV8830_PV_PERIOD_PIXEL_NUMS - OV8830_PV_PERIOD_LINE_NUMS;
