...
#define CAL_DATA_LSC_123        0x010203FF
...
#define MAX_SHADING_Preview_SIZE        (4096) //INT32 
...
#define EEPROM_ERR_MTKOTP_SHADING 0x00002000
...
#define EEPROM_INFO_IN_COMM_SHADING_123     44
