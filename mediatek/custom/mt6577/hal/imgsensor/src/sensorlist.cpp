...
extern UINT32 LensGetCalData(UINT32* pGetSensorCalData);
...
MSDK_SENSOR_INIT_FUNCTION_STRUCT SensorList[] =
{
	...
	RAW_INFO(OV8835MIPI_SENSOR_ID, SENSOR_DRVNAME_OV8835_MIPI_RAW, NULL), 
#endif
    ...
    RAW_INFO(IMX111_SENSOR_ID, SENSOR_DRVNAME_IMX111_MIPI_RAW,LensGetCalData),     
#endif

#if defined(IMX219_MIPI_RAW)
		RAW_INFO(IMX219_SENSOR_ID, SENSOR_DRVNAME_IMX219_MIPI_RAW, LensGetCalData),
#endif

#if defined(IMX119_MIPI_RAW)
 RAW_INFO(IMX119_SENSOR_ID, SENSOR_DRVNAME_IMX119_MIPI_RAW,NULL), 
#endif
