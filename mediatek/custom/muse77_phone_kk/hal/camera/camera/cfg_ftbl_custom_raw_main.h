...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    CONFIG_FEATURE(FID_AE_STROBE,
        ...
        FLASHLIGHT_TORCH    // FLASHLIGHT_REDEYE
    )
#endif
    //..........................................................................
#if 1
    ...
    CONFIG_FEATURE(FID_CAP_SIZE,
        BY_DEFAULT(CAPTURE_SIZE_3264_2448),
    ...
    CONFIG_FEATURE(FID_PREVIEW_SIZE,
        ...
        PREVIEW_SIZE_720_540, PREVIEW_SIZE_800_480,
        PREVIEW_SIZE_864_480, PREVIEW_SIZE_960_540,
    ...
    CONFIG_FEATURE(FID_FRAME_RATE_RANGE,
        ...
        FRAME_RATE_RANGE_5_30_FPS, FRAME_RATE_RANGE_17_30_FPS
    )
#endif
    //..........................................................................
#if 0
