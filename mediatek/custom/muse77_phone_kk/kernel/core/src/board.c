...
struct msdc_hw msdc1_hw = {
    ...
    .flags          = MSDC_SYS_SUSPEND | MSDC_HIGHSPEED| MSDC_SPE | MSDC_WP_PIN_EN | MSDC_CD_PIN_EN | MSDC_REMOVABLE,   //| MSDC_WP_PIN_EN
#else
    .flags          = MSDC_SYS_SUSPEND | MSDC_HIGHSPEED|MSDC_SPE,   //| MSDC_WP_PIN_EN
#endif
    .dat0rddly		= 0,
	.dat1rddly		= 0,
	.dat2rddly		= 0,
